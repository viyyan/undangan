        ...
        <div class="chat__form">
             @if(session()->has('success'))
                ...
                <div class="form__alert">
                    <span>
                        Get our latest credentials.
                    <span>
                    <br>
                    <br>
                    <a class="button button--white button--md"  href="{{ frontAssets('download/clove-credentials-2021.pdf') }}"
                        download="clove-credentials.pdf">
                        <span class="button__label">Download</span>
                    <a>
                </div>
                <script>
                    let url = '{{ frontAssets("download/clove-credentials-2021.pdf") }}';
                    setTimeout(function() {
