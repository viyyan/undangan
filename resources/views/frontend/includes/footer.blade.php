    ...
    <div class="container">
        ...
        <div class="footer__primary">
            ...
            <div class="footer__social">
                <a href="https://www.linkedin.com/company/clove-research-and-marketing-analytics/" title="Clove Resaerch Linkedin">
                    <i class="fab fa-instagram"><img src="{{ frontImages('instagram.svg') }}" alt="Linkedin"></i>
                </a>
                <a href="https://www.instagram.com/clove_research/ " title="Clove Resaerch Instagram">
                    <i class="fab fa-instagram"><img src="{{ frontImages('linkedin.svg') }}" alt="Instagram"></i>
                </a>
            </div>
