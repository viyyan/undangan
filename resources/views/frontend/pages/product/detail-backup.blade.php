...
<div class="masthead_thumb">
    ...
    <p class="title--small white-color">{{ $product->subtitle }}</p>
    </div>
</div>
...
<section class="product-tvc">
    ...
    @if ($product->tvc != null)
    <div class="product-tvc_wrapper">
        <div class="product-tvc_copy">
            <h3 class="title--main">{{ $product->tvc->title }}</h3>
            <p class="text--medium">{{ $product->tvc->desc }}</p>
        </div>
        <div class="product-tvc_video">
            <div class="banner--video-bg">
                <div class="banner--media _media--video">
                <div class="video__youtube" data-video-id="{{ $product->tvc->youtube_id }}" data-autoplay="false"></div>
                </div>
                <div class="video__youtube--cover">
                <div class="banner--bg _bg--image" style="background-image:url('{{ $product->tvc->youtubeThumbUrl }}');"> </div>
