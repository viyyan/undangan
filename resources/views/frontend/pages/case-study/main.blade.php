        ...
        <div class="section__header p-case-study__filter">
                ...
                <div class="select" data-state="close" data-filter="industries" data-value="">
                  ...
                  <div class="select__options">
                    <ul>
                        ...
                        <li>
                            @if(Request::get('industries') !== null && in_array($industry->id, explode(",", Request::get('industries'))))
            ...
            <div class="p-case-study__filter__group">
                ...
                <div class="select" data-state="close" data-filter="order" data-value="">
                    ...
                    <ul>
                        <li>
                        <button type="button" data-value="desc"><span>Latest</span></button>
                        </li>
                        <li>
                        <button type="button" data-value="asc"><span>Oldest</span></button>
                        </li>
                    </ul>
                    </div>
                </div>
