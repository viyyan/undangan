        ...
        <div class="grid grid--center gap--md">
            ...
            <article class="card card--info-bottom">
                ...
                <div class="card__thumb">
                    <div class="card__thumb__image"><img src="{{ frontImages('our_tools-images01.jpg', 2) }}" alt=""/></div>
                </div>
            ...
            <article class="card card--info-bottom">
                <div class="card__inner">
                <div class="card__thumb">
                    <div class="card__thumb__image"><img src="{{ frontImages('our_tools-images02.jpg', 2) }}" alt=""/></div>
                </div>
                <div class="card__tag bg--primary">Registered PowerBI or Tableau</div>
                <div class="card__info">
                    <div class="card__info__inner">
            ...
            <article class="card card--info-bottom">
                <div class="card__inner">
                <div class="card__thumb">
                    <div class="card__thumb__image"><img src="{{ frontImages('our_tools-images03.jpg', 2) }}" alt=""/></div>
                </div>
            ...
            <article class="card card--info-bottom">
                <div class="card__inner">
                <div class="card__thumb">
                    <div class="card__thumb__image"><img src="{{ frontImages('our_tools-images04.jpg', 2) }}" alt=""/></div>
                </div>
            ...
            <article class="card card--info-bottom">
                <div class="card__inner">
                <div class="card__thumb">
                    <div class="card__thumb__image"><img src="{{ frontImages('our_tools-images05.jpg', 2) }}" alt=""/></div>
                </div>
